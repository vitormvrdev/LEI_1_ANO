...
{
    partial class formAlterarVenda
    {
        /// <summary>
        ...
        private void InitializeComponent()
        {
            ...
            cboxAlterarZona = new ComboBox();
            txtBoxAlterarQuantidadeVenda = new TextBox();
            label6 = new Label();
            label7 = new Label();
            txtBoxAlterarCodProdVenda = new TextBox();
            txtBoxAlterarCodVendedor = new TextBox();
            label5 = new Label();
            label4 = new Label();
            label3 = new Label();
            btnBack = new Button();
            ...
            // btnAlterarVenda
            // 
            btnAlterarVenda.BackColor = Color.FromArgb(48, 70, 116);
            btnAlterarVenda.FlatAppearance.BorderSize = 0;
            ...
            Controls.Add(txtBoxAlterarValorVenda);
            Controls.Add(cboxAlterarZona);
            Controls.Add(txtBoxAlterarQuantidadeVenda);
            Controls.Add(label6);
            Controls.Add(label7);
            Controls.Add(txtBoxAlterarCodProdVenda);
            Controls.Add(txtBoxAlterarCodVendedor);
            Controls.Add(label5);
            Controls.Add(label4);
            Controls.Add(label3);
            Controls.Add(panel1);
        ...
        private TextBox txtBoxAlterarValorVenda;
        private ComboBox cboxAlterarZona;
        private TextBox txtBoxAlterarQuantidadeVenda;
        private Label label6;
        private Label label7;
        private TextBox txtBoxAlterarCodProdVenda;
        private TextBox txtBoxAlterarCodVendedor;
        ...
        private ComboBox cboxAlterarCodVenda;
